...
const rules = {
    username: [
        ...
        {min: 5, max: 16, message: "用户名需是5-16位字符", trigger: 'blur'}
    ],
    password: [
        {required: true, message: "请输入密码", trigger: 'blur'},
        {min: 5, max: 16, message: "密码需是5-16位字符", trigger: 'blur'}
    ],
    rePassword: [
    ...
    <el-row class="login-page">
        ...
        <el-col :span="6" :offset="3" class="form">
            ...
            <el-form ref="form" size="large" autocomplete="off" v-if="isRegister" :model="registerData" :rules="rules">
                <el-form-item>
                    <h1 style="margin: 0 auto; display: block;">注册</h1>
                </el-form-item>
            ...
            <el-form ref="form" size="large" autocomplete="off" v-else :model="loginData" :rules="rules">
                <el-form-item>
                    ...
                    <h1 style="margin: 0 auto; display: block;">登录</h1>
                </el-form-item>
                <el-form-item prop="username">
